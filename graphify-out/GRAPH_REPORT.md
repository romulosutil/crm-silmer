# Graph Report - crm-silmer-remove-mfa  (2026-09-09)

## Corpus Check
- 218 files · ~151,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1849 nodes · 2969 edges · 169 communities (120 shown, 49 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d9e96580`
...
- automation-server-config.test.js
- crm.sessions
...
Cohesion: 0.18
Nodes (23): absoluteInstant(), array(), boundedString(), configuredId(), createMetaWhatsAppNormalizer(), deepFreeze(), dispositionFor(), immutableClone() (+15 more)
...
Cohesion: 0.11
Nodes (13): MetaWhatsAppWebhookPayloadError, createChannelEventHandler(), createChannelEventJobHandler(), createInboxService(), InboxConflictError, InboxError, InboxForbiddenError, InboxValidationError (+5 more)
...
Cohesion: 0.24
Nodes (11): contentTypes, demoAccounts, demoAuthenticated(), demoSession(), handleDemoApi(), parseCookies(), port, readJson() (+3 more)
...
Cohesion: 0.21
Nodes (8): createConfiguredAutomationAuthRuntime(), createDurableMetaWebhookRuntime(), createServerApi(), readEnvelopeKey(), requireConfiguredSecret(), SERVICES, createSafeLogger(), KEY
...
Cohesion: 0.13
Nodes (15): createApi(), createWebhookAdmissionGate(), isJsonContentType(), isTransientWebhookPersistenceError(), WEBHOOK_MAX_IN_FLIGHT, WEBHOOK_REQUESTS_PER_SECOND, createWhatsAppWebhookRuntime(), requireSecret() (+7 more)
...
### Community 139 - "channel-envelope.js"
Cohesion: 0.21
...
### Community 148 - "postgres-inbox-repository.js"
Cohesion: 0.28
...
### Community 154 - "inbox-service.js"
Cohesion: 0.24
...
### Community 157 - "freezeInboxRecord"
Cohesion: 0.56
Nodes (5): clone(), createAudit(), InMemoryInboxRepository, publicConversation(), freezeInboxRecord()

### Community 158 - "channel-contract.test.js"
Cohesion: 0.22
Nodes (3): ChannelContractError, assertChannelAdapterContract(), rootUrl

### Community 159 - "tasks.md"
Cohesion: 0.22
...
### Community 160 - "CRM-PROCESSO-VENDAS.md — Processo de Qualificação e Venda (Silmer)"
Cohesion: 0.22
...
### Community 161 - "CHAT NA LANDING PAGE — o que existe e o que falta"
Cohesion: 0.22
...
### Community 162 - "T00.4 - Revisao do PDF canonico da Ficha"
Cohesion: 0.29
...
### Community 163 - "CRM Silmer MVP — Requisitos Rastreáveis"
Cohesion: 0.29
...
### Community 164 - "DATACRAZY-SETUP.md"
Cohesion: 0.47
Nodes (3): Crazy API (WhatsApp), Datacrazy CRM, Vendedor Silmer (AI Agent)

### Community 165 - "PASSO A PASSO — Conectar a Crazy API (quando o cliente aprovar)"
Cohesion: 0.40
...
## Knowledge Gaps
- **711 isolated node(s):** `singleQuote`, `trailingComma`, `name`, `version`, `private` (+706 more)
