// The approved `ficha-canonical-v2` template (D10/D15), extracted from
// `scripts/ficha-pdf-review.mjs` without a single byte of change: the PDF in
// `output/pdf/ficha-canonica-sintetica-v2.pdf` is locked by hash in
// `docs/phase0/ficha-pdf-approval.json`, and a correction would need a new
 ...
 * @returns {string}
 */
export function renderFichaHtml(snapshot, options = {}) {
